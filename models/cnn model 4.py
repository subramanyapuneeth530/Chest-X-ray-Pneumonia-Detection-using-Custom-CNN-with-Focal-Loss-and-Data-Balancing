...
learning_rate = 1e-4  # Same LR; ReduceLROnPlateau will adjust if needed
...
for epoch in range(epochs):
    ...
    result = model.fit(train_data, validation_data=val_data, epochs=1, verbose=1, callbacks=callbacks)
